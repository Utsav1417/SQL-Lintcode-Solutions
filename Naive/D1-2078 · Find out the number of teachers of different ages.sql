...
-- Description
-- Write an SQL statement that queries the teachers table for the number of teachers of different ages and sorts the results in descending order of age, returning the column name as age_count.
...
-- Others Solution
SELECT age, IF(age is NULL, sum(0), count(1)) as age_count 
FROM teachers 
