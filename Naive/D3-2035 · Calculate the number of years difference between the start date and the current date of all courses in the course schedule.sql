...
-- Description
-- Write a SQL statement to query the courses table to calculate the year difference between the time a course was created (created_at) and April 1, 2021, with the course name column displayed as courses_name, the time a course was created as courses_created_at, and the year difference column name displayed as year_diff.
