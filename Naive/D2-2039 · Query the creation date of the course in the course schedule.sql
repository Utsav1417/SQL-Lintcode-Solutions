...
-- Description
-- Write a SQL statement to query the course name name and creation time created_at from the course table courses, extract the course creation date from the course creation time created_at, and use created_date as the result set column name.
