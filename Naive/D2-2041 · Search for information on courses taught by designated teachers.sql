...
-- Description
-- Please write a SQL statement to query the course name, teacher id, and course creation time with teacher id (teacher_id) of 1, 2 or 3 in the course table courses, and arrange the result set in ascending order by teacher id. If the teacher id is the same, then Sorted in descending order by the time the course was created.
