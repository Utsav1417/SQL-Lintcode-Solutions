...
-- Description
-- Write a SQL statement to query the name and creation date of courses which created before August 2020 from the course table courses and alias the column name for the creation date as created_date (the date refers to the part of created_at that does not include a specific time).
