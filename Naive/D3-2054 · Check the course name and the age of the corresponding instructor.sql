...
-- Description
-- Please write a SQL statement to make a full join between the course table courses and the teacher table teachers, querying the course name and the age of the corresponding teacher, with the result columns named course name course_name and teacher’s age teacher_age respectively.
