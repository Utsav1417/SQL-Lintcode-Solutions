...
-- Description
-- Write a SQL statement that queries the course name (name) and the hours of the course creation time (created_at) from the course table courses, and aliases the column name from which the hours are extracted to created_hour.
