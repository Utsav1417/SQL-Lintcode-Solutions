...
-- Description
-- We need to add a new trigger to the teachers table to set the teacher_id to 0 if it exists in the teacher_id of the courses table when a teacher is deleted.
