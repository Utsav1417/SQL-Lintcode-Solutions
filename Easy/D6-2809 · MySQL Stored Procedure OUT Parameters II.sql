...
-- Description
-- Write an SQL statement to create a procedure that returns the number of courses taught by a teacher by teacher id. The procedure has two parameters.
...
-- My Solution
CREATE PROCEDURE GetCourseCountByTeacher(
        IN  Teacher INT,
        OUT total INT
)
BEGIN
...
CALL GetCourseCountByTeacher(3,@total);
SELECT @total;
